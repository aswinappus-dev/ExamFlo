...
document.addEventListener('DOMContentLoaded', () => {
    initializeSidebar(); // Load sidebar on all pages that include main.js
    initializeThemeToggle(); // Load theme toggle on all pages
});
...
// --- Helper for Live Background (if needed on other pages) ---
// This is moved to its own file for clarity
// include <script src="/js/live-background.js"></script> on pages that need it.